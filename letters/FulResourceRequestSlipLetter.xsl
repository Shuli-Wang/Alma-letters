...
<xsl:template match="/">
 ...
 <xsl:if test="notification_data/phys_item_display/available_items/available_item/barcode !=''">
    <span style="font-family:'Free 3 of 9'">
        <xsl:value-of select="notification_data/phys_item_display/available_items/available_item/barcode"/>&#160;
						...
						<tr>
							<td>Type: Item <b>@@note_item_specified_request@@.</b></td>
						</tr>
						<tr>
						...
						<tr>
							<td><h2><b>@@move_to_library@@: </b><xsl:value-of select="notification_data/destination"/></h2></td>
						</tr>
						<tr>
							<td><h2><b>@@request_type@@: </b><xsl:value-of select="notification_data/request_type"/></h2></td>
						</tr>
